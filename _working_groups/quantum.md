...
title: Quantum-Classical Workflows Group
description: Develop hybrid workflows and middleware capable of reconciling quantum and classical systems and software stacks. 
status: Establishing
join: https://forms.gle/4apks9w7VN4ufJpD6
members:
    - name: Silvina Caino-Lores
      role: Chair
      link: https://scainolo.github.io/#/
    - name: Rosa M. Badia
      role: Chair
      link: https://www.bsc.es/badia-rosa-m
    - name: Shantenu Jha
      role: Chair
      link: https://www.pppl.gov/people/shantenu-jha
    - name: Rafael Ferreira da Silva
      link: https://rafaelsilva.com
---

Quantum Computing (QC) systems are increasingly being explored as the next high-impact extension to the computing spectrum, particularly with potential integration into supercomputers and cloud environments. The successful interoperability between classical and quantum systems will depend on middleware interacting with heterogeneous hardware technologies and their associated software stacks and data management methods.
...
- Adapt and maintain workflow management systems for hybrid environments
- Promote interaction and collaboration with the wider quantum computing community
